...
async def _start_single_account(
    ...
    try:
        ...
        transport = TelegramTransport(
            client,
            allowed_user_ids=allowed_ids,
            allow_forum=bool(account_cfg.allow_forum),
            allowed_forum_chat_ids=list(account_cfg.allowed_forum_chat_ids or []),
        ...
        if orch.dashboard_state is not None:
            ...
            # For the primary/default account, set the legacy status fields.
